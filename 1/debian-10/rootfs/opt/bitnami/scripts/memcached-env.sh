...
# STATSD monitoring
export MONITORING_PREFIX="${MONITORING_PREFIX:-stats.memcached}"
export MONITORING_GRAPHITE_HOST="${MONITORING_GRAPHITE_HOST:-localhost}"
export MONITORING_GRAPHITE_PORT="${MONITORING_GRAPHITE_PORT:-8125}"
export MONITORING_SLEEP="{$MONITORING_SLEEP:-60}"
